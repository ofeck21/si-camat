...
$(document).ready(function(){
  ...
  $('.modal').on('show.bs.modal', function(){
    if(!$(this).hasClass('editData')){
      $('#salary_code').val(generateCode(5))
    }
  });
  ...
  dt_table = table.DataTable({
    ...
    columns: [
      ...
      { data: null, className: 'text-center', orderable: false, render: function(row){
        var show ='<a href="/salaries/'+row.id+'/detail" class="btn btn-icon btn-flat-success rounded-circle waves-effect">' +
