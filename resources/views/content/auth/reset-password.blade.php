  ...
  {{-- /Select Language --}}
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        <h2 class="card-title fw-bold mb-1">{{__('auth.reset_password')}} 🔒</h2>
        <p class="card-text mb-2">{{__('auth.enter_new_password')}}</p>
        <form class="auth-reset-password-form mt-2" action="/reset-password" method="POST">
          <div class="mb-1">
            <div class="d-flex justify-content-between">
              <label class="form-label" for="reset-password-new">{{__('auth.new_password')}}</label>
            </div>
          ...
          <div class="mb-1">
            <div class="d-flex justify-content-between">
              <label class="form-label" for="reset-password-confirm">{{__('auth.confirm_password')}}</label>
            </div>
            <div class="input-group input-group-merge form-password-toggle">
          ...
          <button class="btn btn-primary w-100" tabindex="3">{{__('auth.set_new_password')}}</button>
        </form>
